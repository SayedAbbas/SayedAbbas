...
| **Grok / xAI applied to an enterprise workflow** | [Jev Enterprise Decision Eval Lab](https://github.com/SayedAbbas/jev-enterprise-decision-eval-lab) | A decision-model evaluation lab comparing Jev, OpenAI, Claude and Gemini across enterprise routing, change risk, fraud, claims and support—with calibration, latency, cost, coverage and confidence-based escalation metrics. |\n| [Managed Services SLA Recovery Agent](https://github.com/SayedAbbas/managed-services-sla-recovery-agent) — Grok-powered evidence synthesis with deterministic SLA math and approval boundaries. |
